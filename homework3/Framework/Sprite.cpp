...
{
	RECT rtIntersect;
	RECT rtSprite = {rtBoundingBox.left,rtBoundingBox.top,rtBoundingBox.right,rtBoundingBox.bottom};
...
bool CSprite::CollideWith(CSprite &sprite) 
{
	...
	RECT rt1 = {rtBoundingBox.left,rtBoundingBox.top,rtBoundingBox.right,rtBoundingBox.bottom};
	RECT rt2 = {sprite.GetBoundingBox()->left,sprite.GetBoundingBox()->top,sprite.GetBoundingBox()->right,sprite.GetBoundingBox()->bottom};

	return IntersectRect(&rtIntersect,&rt1,&rt2);
}
